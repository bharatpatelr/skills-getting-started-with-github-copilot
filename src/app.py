...
activities = {
    ...
    "Soccer Team": {
        "description": "Competitive soccer team practicing drills, tactics and playing matches",
        "schedule": "Mondays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 18,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Pick-up games, skill development and intramural competitions",
